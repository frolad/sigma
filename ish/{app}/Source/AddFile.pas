...
End;
///////////////////////////////////////////////////////////////////
//перевод файла из списка стандартных в список редактируемых
///////////////////////////////////////////////////////////////////
...
Begin
     ...
     Begin
          ...
          Begin
               ...
               Begin
                    If MessageDlg('Заменить '+NewFileName+' ?', mtConfirmation,mbOKCancel, 0)=mrOK Then Begin
...
End;
///////////////////////////////////////////////////////////////////
//перевод файла из списка редактируемых в список стандартных
///////////////////////////////////////////////////////////////////
...
Begin
     ...
     Begin
          ...
          If FileExists(NewFileName) Then
          Begin
            // Если не нашли в списке стандартных этот файл:
          ...
          Else
          Begin
            MessageDlg('Файл с таким именем не может быть '+
                        'выбран из числа стандартных.',
                        mtWarning, [mbOK], 0);
          End;
     End;
End;
///////////////////////////////////////////////////////////////////
//сохранение изменений имен файлов
///////////////////////////////////////////////////////////////////
...
End;
///////////////////////////////////////////////////////////////////
//поиск/задание имени файла формы
///////////////////////////////////////////////////////////////////
...
Begin
     ...
     OpenDialog1.Filter:='Файлы формы|*.sfm|Файлы строй формы|*.frm';
...
End;
///////////////////////////////////////////////////////////////////
//изменение имени файла для редактирования
///////////////////////////////////////////////////////////////////
...
Begin
     ...
     Begin
          ...
          OpenDialog1.Title:='Открыть файл программы';
...
End;
///////////////////////////////////////////////////////////////////
//изменение имени файла из стандартного набора
///////////////////////////////////////////////////////////////////
...
Begin
     ...
     If OpenDialog1.Execute Then
     Begin
          If LowerCase(ExtractFilePath(OpenDialog1.FileName))=Project_GetSource Then//основные
          begin
               if FileExists(OpenDialog1.FileName) then
               begin
