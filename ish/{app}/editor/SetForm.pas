        ...
        Begin
             ...
             Begin
                  ...
                  Begin
                       ...
                       End;
                       // вычислить площадь зоны
                       // вычислить площать треугольника 1-2-8
                       ...
                       // вычислить площать треугольника 2-3-4
                       ...
                       // вычислить площать треугольника 4-5-6
...
begin
     MainParams:=GetMainParam;
     FormSettings.GroupBox3.Caption:='Зона <Количество зон: '+inttostr(MainParams.INRG)+'>';
     ...
     Begin
          ...
          End;
     End;
     FormSettings.GroupBox4.Caption:='Узел <Количество узлов: '+IntToStr(Form_GetNodeCount)+'>';
...
Begin
    ...
    // создать панель подсчета расстояний
...
Begin
     ...
     // Маркин Н. Проверить нужно ли определять расстояние между узлами
...
// Обработка введеного значения в поле ввода координаты X
...
// Обработка введеного значения в поле ввода координаты Y
...
begin
  //отобразить форму подсчета расстояний
  ...
  begin
    ...
    //SetForm1.btnCalcDistance.Caption := 'Скрыть подсчет расстояний';
  end
  else
  begin
    // скрыть панель
    CalcDistanceForm.Visible := false;
    //SetForm1.btnCalcDistance.Caption := 'Открыть подсчет расстояний';
  end;
end;
