...
begin
  ...
  begin
    ...
    begin
      ...
      // скрыть вывод второго узла и расчитанного расстояния
...
begin
  ...
  // сбросить количество выбранных узлов
  nodeCount := 0;
end;
...
begin
  ...
  SetForm1.btnCalcDistance.Caption := 'Расчет расстояний';
...
begin
  // установить высоту формы равной высоте панели с кнопками и
  // высоте панели подсчета расстояний по дуге + высота заголовка окна
